...
alias chownlocal='/usr/bin/sudo /bin/chmod g+rwx /usr/local/. /usr/local/bin /usr/local/etc /usr/local/lib /usr/local/sbin /usr/local/share /usr/local/share/man /usr/local/share/man/man1 /usr/local/share/man/man5 /usr/local/share/man/man8 /usr/local/share/info /usr/local/share/doc; /usr/bin/sudo /usr/sbin/chown dcrossland /usr/local/. /usr/local/bin /usr/local/etc /usr/local/lib /usr/local/sbin /usr/local/share /usr/local/share/man /usr/local/share/man/man1 /usr/local/share/man/man5 /usr/local/share/man/man8 /usr/local/share/info /usr/local/share/doc; /usr/bin/sudo /usr/bin/chgrp admin /usr/local/. /usr/local/bin /usr/local/etc /usr/local/lib /usr/local/sbin /usr/local/share /usr/local/share/man /usr/local/share/man/man1 /usr/local/share/man/man5 /usr/local/share/man/man8 /usr/local/share/info /usr/local/share/doc; /usr/bin/sudo /bin/chmod g+rwx /Library/Caches/Homebrew; /usr/bin/sudo /usr/sbin/chown dcrossland /Library/Caches/Homebrew; /usr/bin/sudo /usr/bin/chgrp admin /Library/Caches/Homebrew; '
